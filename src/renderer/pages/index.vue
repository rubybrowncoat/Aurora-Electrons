    ...
    <v-container fluid v-if="RaceID">
      <v-row justify="start">
        <v-col cols="12">
          ...
          <v-btn class="overline d-inline-block" elevation="1" :color="showShipyards ? 'purple accent-1' : 'light'" small tile dense borderless @click="showShipyards = !showShipyards">Shipyards</v-btn>
